...
/**
 * Cette classe fournie des services permettant de manipuler un fichier de
 * symptômes.
 * 
 * @author Pano
 *
...
public class AnalyticsCounter {
	...
	/**
	 * Cette méthode parcour la liste passée en paramètre et elle retourne le nombre
	 * d'occurrence de chaque symptôme de la liste.
	 *
	...
	/**
	 * Cette méthode crée le fichier de sortie dans le répertoire personel de
	 * l'utilisateur à partir de la map passée en paramètre.
	 *
	 * @param mapSymptomsOccurences Map contenant pour chaque maladie le nombre
	 *                              d'occurrence qui lui est associé.
	...
	public void save(Map<String, Integer> mapSymptomsOccurences) throws Exception {
		writeSymptomDataFromFile.writeSymptomsAndOccurences(mapSymptomsOccurences);
	}
}
